 ...
 */
export type SignalingEventType = 'connected' | 'authenticated' | 'auth_error' | 'room_joined' | 'room_users' | 'user_joined' | 'user_left' | 'offer' | 'answer' | 'candidate' | 'disconnected' | 'error';
/**
 ...
 */
export type ClientEventType = 'state_changed' | 'room_joined' | 'room_left' | 'user_joined' | 'user_left' | 'transcript' | 'speech_start' | 'speech_end' | 'audio_input' | 'audio_output' | 'error' | 'disconnected';
/**
 * Event callback type
 */
